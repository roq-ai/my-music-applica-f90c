  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover, Share, and Enjoy with My Music Application - Your Ultimate Guide to New Song Releases Across All Major Platforms."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover, Share, and Enjoy with My Music Application - Your Ultimate Guide to New Song Releases Across All Major Platforms.`}
            </Text>
            <Box
